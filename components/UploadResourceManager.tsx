...
const subjects = ["SNED", "SNED - Life Skills", "SNED - Care Skills", "Kindergarten - Numeracy", "Kindergarten - Literacy", "ENGLISH", "MAKABANSA", "MATHEMATICS - REGULAR", "MATHEMATICS - SPS", "SCIENCE", "SCIENCE - SPS", "FILIPINO", "MUSIC & ARTS", "PHYSICAL EDUCATION & HEALTH", "Reading and Literacy and Language", "EPP", "Technology and Livelihood Education (TLE)", "TLE - Agriculture and Fishery Arts", "TLE - Family and Consumer Science", "TLE - Industrial Arts", "TLE - Information and Communications Technology", "GMRC", "VALUES EDUCATION (VE)", "Edukasyong Pantahanan at Pangkabuhayan (EPP)", "Araling Panlipunan (AP)", "Alternative Learning System (ALS)", "Effective Communication", "General Mathematics", "General Science", "Life and Career Skills", "Pag-aaral ng Kasaysayan at Lipunang Pilipino", "ELECTIVES", "TECHPRO"].sort((a, b) => a.localeCompare(b));
